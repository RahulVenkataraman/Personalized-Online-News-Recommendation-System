...
public final class search_4 extends JFrame
 {


public search_4(final String[] display,final String username_4,final String password_4) throws Exception
{
     this.setVisible(false);

     String sport_name=display[3];
...
JButton back_3=new JButton("<<BACK");
    ...
    back_3.addActionListener(new ActionListener(){public void actionPerformed(ActionEvent e)
    {
            ...
            try
            {
            search_3 s3 = new search_3(display,username_4,password_4);
            }
            catch (Exception ex)
            {
            }
